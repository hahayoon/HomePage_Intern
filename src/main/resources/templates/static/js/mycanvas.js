...
function newDraw( projectTime ,  studyTime ,  playTime ){
     ...
     num1 = document.getElementById('projectTime').value;
     num2 = document.getElementById('studyTime').value;
      num3 = document.getElementById('playTime').value;
...
ctx.onload = function () {
    ...
    console.log(roadimg.width + " " +roadimg.height);
    onload(canvas, ctx)
